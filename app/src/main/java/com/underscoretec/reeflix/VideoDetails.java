...
public class VideoDetails extends AppCompatActivity {
    ...
    private void initializePlayer() {
        ...
        /*downloadCache =
                new SimpleCache(downloadCacheFolder, new NoOpCacheEvictor());
    ...
    private HlsMediaSource buildMediaSource(Uri uri) {
        ...
        HlsMediaSource hlsMediaSource = new HlsMediaSource.Factory(dataSourceFactory).setPlaylistParserFactory(
